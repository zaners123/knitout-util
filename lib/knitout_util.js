...
class KnitoutUtil extends knitout.Writer {
	...
	constructor() {
		...
		this.STOCKINETTE_EVEN = {
			'name':'Stockinette',
			'front':[['k',' ']],
			'back': [['k',' ']],
			'square': [['k',' ']],
		}
		this.STOCKINETTE_ODD = {
			'name':'Stockinette',
			'front':[[' ','k']],
			'back': [[' ','k']],
			'square': [[' ','k']],
	...
	bindon_tube(carrier, X1, X2) {
		this.comment("EVEN")
		this.knit_line_of_tube(this.STOCKINETTE_EVEN.front[0], carrier, X1, X2,'+','f')
		this.knit_line_of_tube(this.STOCKINETTE_EVEN.back [0], carrier, X1, X2,'-','b')
		this.comment("ODDS")
		this.knit_line_of_tube(this.STOCKINETTE_ODD .front[0], carrier, X1, X2,'+','f')
		this.knit_line_of_tube(this.STOCKINETTE_ODD .back [0], carrier, X1, X2,'-','b')
		this.run(this.gen_arbtube(this.STOCKINETTE, carrier, 1, X1, X2))
	}
